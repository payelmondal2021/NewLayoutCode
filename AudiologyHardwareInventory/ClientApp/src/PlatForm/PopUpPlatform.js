                    ...
                    <form onSubmit={this.props.handleSubmit}>
                        <ModalBody>
                            <div >
                                ...
                                <label for="form7" class="pb-2">Alias</label><br></br>
                                <textarea required id="txtAlias" defaultValue={this.props.data.alias} placeholder="Please Enter Alias" name="name2" rows="2" cols="60" />
                            </div>
                        </ModalBody>
                        <ModalFooter >
