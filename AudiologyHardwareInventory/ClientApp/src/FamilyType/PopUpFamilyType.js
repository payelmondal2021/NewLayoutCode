...
export class PopUpFamilyType extends Component {
    static displayName = PopUpFamilyType.name;
    constructor(props) {
        super(props);
        this.state = {
          testval:''
            ...
            <div>
                <Modal isOpen={this.props.data.modal} fade={this.props.data.fade} toggle={this.props.toggle}>
                    ...
                    <form onSubmit={this.props.handleSubmit}>
                        <ModalBody>
                            <div >
                                <label for="form7" class="pb-2">Family Name</label><br></br>
                                <textarea required id="txtFamilyName" defaultValue={this.props.data.familyName} name="name" placeholder="Please Enter Family Name" rows="2" cols="60" />
                        ...
                        <ModalFooter >
                            ...
                            <Button onClick={this.onTrigger}>Cancel</Button>
                        </ModalFooter>
                    </form>
                </Modal>
